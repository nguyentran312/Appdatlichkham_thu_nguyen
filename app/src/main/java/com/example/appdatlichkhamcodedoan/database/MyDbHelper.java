package com.example.appdatlichkhamcodedoan.database;
...
public class MyDbHelper extends SQLiteOpenHelper {
    public static final String DB_NAME = "DS_appdatlichkham";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        //Tài khoản ADMIN
        String sqlAdmin1 = "INSERT INTO tbAccount VALUES(1,'Thu','thu123','0123456','Tran Anh Thu','Admin',null)";
        sqLiteDatabase.execSQL(sqlAdmin1);
        String sqlAdmin2 = "INSERT INTO tbAccount VALUES(2,'Nguyen','nguyen123','123456','Tran Thao Nguyen','Admin',null)";
        sqLiteDatabase.execSQL(sqlAdmin2);
